...
import 'package:rizqbachaoapp/Data/firebase_org_repository.dart';
import 'package:rizqbachaoapp/Data/firebase_user_repository.dart';
import 'package:rizqbachaoapp/Domain/org_respository.dart';
import 'package:rizqbachaoapp/Features/Profile/profile_provider.dart';
import 'package:rizqbachaoapp/Features/Signup%20Screens/signup_donor_provider.dart';
import 'package:rizqbachaoapp/Features/Signup%20Screens/signup_ngo_provider.dart';
import 'package:rizqbachaoapp/Splash.dart';
      ...
      home: StreamBuilder<User?>(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              return Splash(); // else show login page
            }
