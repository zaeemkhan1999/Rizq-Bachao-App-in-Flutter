...
import 'package:rizqbachaoapp/Features/Signup%20Screens/signup_ngo.dart';
import 'package:rizqbachaoapp/main_screen.dart';
        ...
        child: Stack(
          children: [
            Positioned(
                ...
                child: login_container_collector()),
            Positioned(
...
class login_container_collector extends StatefulWidget {
  ...
  @override
  State<login_container_collector> createState() =>
      _login_container_collectorState();
}
