...
import 'package:rizqbachaoapp/Features/Login%20Screens/login_provider.dart';
import 'package:provider/provider.dart';
import '../../main.dart';
import '../../main_screen.dart';
import '../Signup Screens/signup_donor.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [
            Positioned(
                bottom: screenHeight * (-0.45), child: login_container()),
            Positioned(
              bottom: screenHeight * 0.55,
              right: 28,
              child: Container(
                  child: Image.asset(
                'assets/images/login-donor-page-img.png',
                scale: 2,
              )),
            ),
          ],
...
class login_container extends StatefulWidget {
  const login_container({Key? key}) : super(key: key);
...
class _login_containerState extends State<login_container> {
                  ...
                  TextButton(
                    onPressed: () {
                      ...
                      Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => SignupDonar()),
                      );
  ...
  Future logIn() async {
    ...
    if (context.read<LoginProvidor>().list[0].organisation.toString().length >
        2) {
      print("This is not a Donor account!");
    } else {
      showDialog(
          context: context,
