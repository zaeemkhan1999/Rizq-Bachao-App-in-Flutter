...
class ProfileDonar extends StatefulWidget {
  const ProfileDonar({Key? key}) : super(key: key);

  @override
  State<ProfileDonar> createState() => _ProfileDonarState();
}

class _ProfileDonarState extends State<ProfileDonar> {
        ...
        child: Column(
          ...
          children: [
            ...
            CircleAvatar(
              ...
              backgroundImage: AssetImage('assets/images/Group77.png'),
              radius: 80,
            ),
            const SizedBox(
              height: 5.0,
