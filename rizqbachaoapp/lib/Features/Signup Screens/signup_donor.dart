...
import 'package:rizqbachaoapp/Features/Signup%20Screens/signup_donor.dart';
import 'package:rizqbachaoapp/Features/Signup%20Screens/signup_donor_one.dart';
                          ...
                          builder: (context) => StreamBuilder<User?>(
                              ...
                              builder: (context, snapshot) {
                                if (snapshot.hasData) {
                                  ...
                                  return SignupDonorOne(); // else show login page
                                }
                              }),
                        ),
                      );
